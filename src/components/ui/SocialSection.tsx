    ...
    <ul className="flex items-center gap-4 pt-7">
      ...
      <li>
        <a
          ...
          target="_blank"
        >
          <svg xmlns="http://www.w3.org/2000/svg" className="w-8 h-8 transition-none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
            <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
